...
class RNN_Sine():
    ...
    def __init__(self, n_steps, n_inputs, batch_size, hidden_size, input_train_feature, input_train_label,
                 input_test_feature, input_test_label, n_output):
    ...
    def seq_predict_model(self, X, W, b):
        ...
        outputs, states = tf.contrib.rnn.static_rnn(
            rnn_cell, X, initial_state=init_state)                           # outputs -- [n_steps,batch_size,hidden_size]
...
if __name__ == '__main__':
    ...
    rnn = RNN_Sine(n_steps, n_inputs, batch_size, hidden_size, input_train_feature, input_train_label,
                   input_test_feature, input_test_label, n_output)
    rnn.fit()
